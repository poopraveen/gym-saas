...
export default function AddMemberModal({
  ...
  const update = (key: keyof MemberFormData, value: string | number) => {
    setForm((f) => {
        ...
        <form onSubmit={handleSubmit} className="modal-form">
          ...
          <div className="form-row form-row-radio">
            ...
            <div className="radio-group">
              <label className="radio-opt"><input type="radio" name="gender" value="Male" checked={form.Gender === 'Male'} onChange={(e) => update('Gender', e.target.value)} /> Male</label>
              <label className="radio-opt"><input type="radio" name="gender" value="Female" checked={form.Gender === 'Female'} onChange={(e) => update('Gender', e.target.value)} /> Female</label>
            </div>
          </div>
          <div className="form-row">
            <label>Contact</label>
